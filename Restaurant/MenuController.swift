...
class MenuController {
    ...
    func updateBaseURL(ipAddress: String) {
        ...
        print("Base URL updated to http://"+ipAddress+":8090/")
    }
    ...
    func submitOrder(menuIds: [Int], completion: @escaping (Int?) -> Void) {
        ...
        request.httpMethod = "POST" // set the request's default type from GET to POST
        request.setValue("application/json", forHTTPHeaderField: "Content-Type") // JSON is the data type I'll be sending
